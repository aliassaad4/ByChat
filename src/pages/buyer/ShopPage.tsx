...
import {
  ...
  MessageCircle, ShoppingCart, Plus, Check, Phone
} from "lucide-react";
    ...
    <div className="space-y-6 relative">
      ...
      <div className="glass-card overflow-hidden animate-fade-in">
        ...
        <div className="px-6 pb-6 -mt-8 relative">
          ...
          {seller.whatsapp_connected && seller.whatsapp_phone_number && (
            <a
              href={`https://wa.me/${seller.whatsapp_phone_number.replace(/\D/g, "")}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-full bg-[#25D366] hover:bg-[#1da851] text-white text-sm font-medium transition-colors"
            >
